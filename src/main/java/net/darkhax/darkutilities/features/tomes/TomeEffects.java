...
public class TomeEffects {
    ...
    public static final TomeEffect<Player, InteractionResult> RESET_ENCHANTMENT_SEED = TomeEffect.withExpCost(TomeEffect.withCooldown(TomeEffects::resetEnchantmentSeed, 20 * 30), 20);
    ...
    @Nullable
    private static InteractionResult resetEnchantmentSeed(ItemStack usedStack, Player player, InteractionHand hand, Player target) {
